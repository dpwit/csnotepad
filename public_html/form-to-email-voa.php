...
session_start();
	...
	define(CONTACT_FAIL,		'signup-virtual-office-fullform.php');
	...
	$email_from = 'contact@csnotepad.co.uk';
        ...
        if(!$captcha){
			header("Location: signup-virtual-office-fullform.php?CaptchaFail=True#recaptchaerror");
									...
									<tr>
										<td>
											<table style="font-size: 14px; font-family: Arial" cellspacing="5">
												...
												<tr>
													<td>
														<strong>CSnotepad - Virtual Office Address</strong><br/><br/>
													</td>
												</tr>
												<tr>
													<td>
...
HTML;
	...
	function emailClient($mail, $values) {
		...
		$mail->From = 'contact@csnotepad.co.uk';
		$mail->FromName = $name;
		$mail->Subject = 'Virtual Office Address setup request';
		$mail->ClearAddresses();
