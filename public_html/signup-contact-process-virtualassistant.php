...
session_start();
	...
	define(CONTACT_FAIL,		'signup-virtualassistant.php');
	...
	$email_from = 'contact@csnotepad.co.uk';
        ...
        if(!$captcha){
			header("Location: signup-virtualassistant.php?CaptchaFail=True#recaptchaerror");
	...
	switch($service) {
		case 'Virtual Assistant':
			$file['name'] = 'CSnotepad virtual assistant information pack.pdf';
			$file['path'] = dirname(__FILE__) . '/html/pages/signup_process/CSnotepad virtual assistant information pack.pdf';
			break;
		default:
