...
src="//www.googleadservices.com/pagead/conversion/1055112536/?label=5262CN-YjWkQ2PqO9wM&amp;guid=ON&amp;script=0"/>
		...
		<?php else : ?>
			...
			<div style="margin: 0 auto; width: 1323px;">
				...
				<br>
				<h1 class="fancy" style="border-bottom: none; color: #241c15; font-size: 24px; font-weight: 400; width: 1120px;">A fully inclusive virtual office service; designed specifically for business customers' looking for a professional, secure UK office address able to forward post on to customers anywhere in the world.</h1>
				<br>
				<hr style="width: 500px;">
				<div>
					<form action="/form-to-email-virtual-office-rem" id="paymentForm" method="POST">
						<div style="display: inline-flex; margin: auto;">
							...
							<div style="display: inline-block; margin: 20px; width: 29%;">
								...
								<div>
									<span><img src="/images/2.png" alt="" style="width: 30px; height: 30px; display: inline-block; vertical-align: middle; padding-right: 10px; padding-bottom: 3px;"></span><h2 class="fancy" style="font-size: 18px; color: #39F; display: inline-block;">Company details</h2>
								</div>
								...
								<div id="third" style="display: inline-block; margin-top: -20px;">
									<div class="form-row">
										...
										<h3 class="fancy" style="font-size: 14px; padding-left: 0px;">
											...
											<font style="font-size: 14px; color: #241c15;">Please let us know what names you would like registered on your account (up to 3 names are included free per account).</font>
											<br>
											<br>
											
											<div class="form_row">
												<label for="addNames" style="color: #241c15;font-size: 15px;">Name 1 <asterix>*</asterix> company name</label>
												<input type="text" name="addNames" required />
											</div>
											<div class="form_row"> 
												<label for="nameTwo" style="color: #241c15;font-size: 15px;">Name 2 additional name</label>
												<input type="text" name="nameTwo" />
											</div>
											<div class="form_row"> 
												<label for="nameThree" style="color: #241c15;font-size: 15px;">Name 3 additional name</label>
							...
							<div style="display: inline-block; margin: 20px; width: 34%;">
								...
								<div id="first" style="width: 250px; margin-top: -10px; display: inline-block;">
									...
									<div class="form_row">
										...
										<select name="service" id="service" required onchange="displayService()">
								...
								<div  class="form_row" style="border: 1px solid #39F; padding: 10px; width: 450px;">
									<h3 class="fancy" style="font-size: 15px; color: #241c15; padding: 0px; margin-top: 0px;">
										<font color="#ff8834">•</font>&nbsp;Monthly &ndash; &pound;24.99 per month
										<br>
										<br>
										<font color="#ff8834">•</font>&nbsp;Annually &ndash; &pound;210 per year
										<br>
									</h3>
									...
									<select name="term" id="term" required onchange="displayTerm()">
										<option value="">Please choose...</option>
										<option value="24.99">&pound;24.99 &ndash; <span value="Monthly">Monthly</span></option>
										<option value="210.00">&pound;210 &ndash; <span value="Annually">(equivalent to just &pound;17.50 a month)</span></option>
									</select>
									<br>
						...
						<div style="display: inline-flex; margin: auto;">
							<div style="display: inline-block; margin: 0 20px 20px 20px; width: 37%;">
								...
								<div class="form_row" style="color: #241c15; margin: 20px 0 20px 10px; text-align: center; width: 500px;">
									<label for="subtotal" style="color: #241c15; font-size: 18px;">Virtual Office:</label> &pound;<span id="termAmount"></span>
									<hr>
							...
							<div style="display: inline-block; margin: 50px 20px 20px 40px; width: 37%;">
								...
								<h3 class="fancy" style="font-size: 11px; padding-left: 0px; width: 550px;">
									...
									<div id="stored">
										...
										<br>
										<font style="font-size: 11px;">If you would like your mail stored for collection we will charge:<br>
										Letters &ndash; 75p<br>
										Parcels/recorded delivery items &ndash; &pound;1.50
										<br>
										<br>
										Note, mail received on your behalf and stored for collection will be held for free for the first 30 days. We will charge £5 a month plus VAT for all mail still being held after 30 days (up to 50 letters can be held).</font>
										<br>
									</div>
								</h3>
							</div>
