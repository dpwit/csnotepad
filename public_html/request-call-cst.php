...
session_start();
	...
	define(CONTACT_SUCCESS,		'/customer-support-team.php');
	define(CONTACT_FAIL,		'/customer-support-team.php');
	...
	$email_from = 'Website Enquiry <info@csnotepad.co.uk>';
        ...
        if(!$captcha){
			header("Location: customer-support-team?CaptchaFail=True#recaptchaerror");
