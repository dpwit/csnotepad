...
session_start();
	...
	define(CONTACT_SUCCESS,		'/telephone-answering-brighton-li.php');
	define(CONTACT_FAIL,		'/html/our-services/telephone-answering-brighton-li');
	...
	$email_from = 'Website Enquiry <info@csnotepad.co.uk>';
        ...
        if(!$captcha){
			header("Location: /html/our-services/telephone-answering-brighton-li?CaptchaFail=True#recaptchaerror");
