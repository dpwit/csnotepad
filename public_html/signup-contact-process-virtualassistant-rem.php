...
session_start();
	...
	define(CONTACT_FAIL,		'signup-virtualassistant-rem.php');
	...
	$email_from = 'contact@csnotepad.co.uk';
        ...
        if(!$captcha){
			header("Location: signup-virtualassistant-rem.php?CaptchaFail=True#recaptchaerror");
	...
	switch($service) {
		case 'Virtual Assistant':
			$file['name'] = 'CSnotepad virtual assistant information pack rem.pdf';
			$file['path'] = dirname(__FILE__) . '/html/pages/signup_process/CSnotepad virtual assistant information pack rem.pdf';
			break;
		default:
