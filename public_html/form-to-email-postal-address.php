...
$_SESSION['get-email'] = $_POST['email'];
	...
	define(CONTACT_SUCCESS,		'/html/pages/signup-thankyou-postal-address.php');
	define(CONTACT_FAIL,		'signup-postal-address-fullform.php');
	...
	$email_from = 'contact@csnotepad.co.uk';
        ...
        if(!$captcha){
			header("Location: signup-postal-address-fullform.php?CaptchaFail=True#recaptchaerror");
...
HTML;
	...
	header('location: /html/pages/signup-thankyou-postal-address.php');
