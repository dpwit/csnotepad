...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<meta name="description" content="<?php if($context->metaDescription) { ?><?=$context->metaDescription?><?php } else {?><?=$context->pageTitle ?> - LiveWebChat for your business, providing you with both the software and the staff to actively engage your website visitors<?php } ?>" />
