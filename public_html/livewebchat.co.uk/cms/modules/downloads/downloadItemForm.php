...
<!--<tr height="30">
<td class="title1" align="right" > File Name  <?php echo $row["fileVar"] ?> </td>
<td> 
<select name="filenName" class="formbox" >   <?php echo $row["fileVar"] ?>   
<?php //listFiles ($filePathVar.'/',$row["fileVar"]); ?>
</select>
...
<?php if ($row["uid"]== $rowData["uid"]) {echo "selected";} ?> >
