...
<? } ?>
        ...
        <meta name="description" content="Started in 1990 Loaded enjoyed global success with Wildchild, Pizzaman; more recently Freemasons, one of the most successful UK dance acts">
		...
		<link rel="stylesheet" type="text/css" href="css/loaded.css" />
...
s.parentNode.insertBefore(ga, s);
	...
	<div id="header">
		<div class="inner"><a href="/loaded" title="Loaded Home">
			<h1>Loaded</h1></a>
            <h2>Freemaisons</h2>
...
<?$this->renderComponent('menu',array('skipWrap'=>true));?>
	...
	<div id="albums">
		<div class="inner"><div id="carousel"><a href="/shop/loaded"><img src="images/albums.png" width="961" height="97" alt="Album Flash Widget" style="display: block" /></a></div></div>
		<script type="text/javascript">
