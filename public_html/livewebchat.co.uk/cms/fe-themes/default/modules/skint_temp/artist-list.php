				<div id="artistsMain" class="box">
					<ul>
						...
						?>
						<li<?=$class?>><a href="<?=$artist->getUrl()?>"><img class="image" src="<?= $artist->image ? $artist->image('galleryThumb',array('default'=>'png')) : 'images/placeholder.png'?>" /><span><?=$artist->name?></span></a></li>
						<?php $i++; } ?>
					</ul>
				</div>
