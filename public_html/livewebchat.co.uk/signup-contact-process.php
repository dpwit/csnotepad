					...
					<tr>
						<td>
							<table style="font-size: 14px; font-family: Arial" cellspacing="5">
								...
								<tr><td>It's great that you want to find out more about our LiveWebChat service.<br/><br/></td></tr>
								<tr><td>Attached to this email is a PDF which contains a full overview of the service as well as prices.<br/><br/>One of the team will shortly be sending you an email to introduce themselves as your point of contact, however if you have any questions in the meantime then please don't hesitate to get in touch on <strong>01273 741113</strong>.</td></tr>
...
HTML;
	...
	function emailClient($mail, $values) {
		...
		$mail->ClearAddresses();
		$mail->AddAddress('warren@francis.sk');
		$mail->AddAddress('info@livewebchat.co.uk');
		$mail->AddAddress('rdon11@hotmail.com');
