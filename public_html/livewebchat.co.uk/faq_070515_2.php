...
•	<a href="#Can I change the design">Can I change the design of the chat window and button?</a><br>
•	<a href="#How do I get started"> How do I get started?</a><br>
<br>
<p>
<a name="Is the software included"></a><h2><i>Is the software included in your costs?</i></h2> Yes. Our costs are all inclusive so there are no additional software costs.  
<br>
<p>
<a name="Is there any software"></a><h2><i>Is there any software that I need to install or maintain?</i></h2> No. There is no software that you need to install or maintain. There are a couple of lines of code you need to paste on your website, that’s it.
<br>
<p>
<a name="How can you be certain"></a><h2><i>How can you be certain that Live Chat will increase your sales?</i></h2> If you already have a viable business and online visitors, then it makes sense that you’d see an increase in sales. It's not rocket science; if you are there for your customers (via a live chat service) when they need you, and their questions are answered promptly, common sense dictates that they are more likely to buy from you.
<br>
<p>
<a name="How does Live Web Chat"></a><h2><i>How does ‘Live Web Chat’ give me an edge over the competition?</i></h2> Most of your competitors aren’t helping their website visitors to make a purchase unless the visitor calls them. By using ‘Live Web Chat’ potential customers have someone who can walk them through any problems or queries without them having the barrier of needing to pick up the phone. If they become confused or have a question that may make or break a sale, your team of live chat agents are there to clarify matters. This helps eliminate 'bounce' away from websites and therefore reduces lost income.
<br>
<p>
<a name="How much does the service cost"></a><h2><i>How much does the service cost?</i></h2> The ‘Live Web Chat’ service starts from just £65 per month. Download our full list of prices here. 
<br>
<p>
<a name="Where is Live Web Chat"></a><h2><i>Where is ‘Live Web Chat’ based?</i></h2> We’re based in Brighton & Hove, East Sussex and all of our staff are from the local area.
<br>
<p>
<a name="Am I tied"></a><h2><i>Am I tied in to a long term contract?</i></h2> No. The notice period is just two months from the end of the month notice is given.  
<br>
<p>
...
<br>
<p>
<a name="Can I change the design"></a><h2><i>Can I change the design of the chat window and button?</i></h2> Yes, it will be configured to your requirements from the start.  	
<br>
<p>
