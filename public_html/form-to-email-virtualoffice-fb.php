...
$_SESSION['get-email'] = $_POST['email'];
	...
	define(CONTACT_SUCCESS,		'/html/pages/signup-thankyou-virtualoffice-fb.php');
	define(CONTACT_FAIL,		'signup-virtualofice-fullform-fb.php');
	...
	$email_from = 'contact@csnotepad.co.uk';
        ...
        if(!$captcha){
			header("Location: signup-virtualofice-fullform-fb.php?CaptchaFail=True#recaptchaerror");
...
HTML;
	...
	header('location: /html/pages/signup-thankyou-virtualoffice-fb.php');
