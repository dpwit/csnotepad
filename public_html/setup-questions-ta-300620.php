	...
	<body>
		...
		<div style="margin: 0 auto; width: 1323px;">
			...
			<div class="bg-call-plan-box" style="margin: 50px auto; padding: 20px 135px; width: 72%;">
				...
				<p>
					<label for="skip-section" style="color: #241c15; display: inline-flex; font-size: 16px;">Tick here if you would like to skip this section and for us to complete the setup of your service over the phone or via email instead. 
						<input type="checkbox" name="skipSection" id="skipSection" onchange="window.location.href='#next'" style="width: 20px;">
					</label>
				</p>
			</div>
