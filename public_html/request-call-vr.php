...
session_start();
	...
	define(CONTACT_SUCCESS,		'/virtual-receptionists.php');
	define(CONTACT_FAIL,		'virtual-receptionists.php');
	...
	$email_from = 'Website Enquiry <info@csnotepad.co.uk>';
        ...
        if(!$captcha){
			header("Location: virtual-receptionists.php?CaptchaFail=True#recaptchaerror");
