...
session_start();
	...
	switch($service) {
		...
		case 'Charities':
			...
			$file['path'] = dirname(__FILE__) . '/html/pages/signup_process/CSnotepad telephone answering for Charities.pdf';
			break;
		default:
	 ...
	 */
	function emailUser($mail, $email, $file, $values) {
		$mail->IsHTML(true);
											...
											<table style="font-size: 14px; font-family: Arial" cellspacing="5">
												...
												<tr>
													<td>
														...
														In the meantime if you have any questions or would like to have a chat to one of our friendly team then please don't hesitate to call on 01273 741400 or email us at <a href="mailto: info@csnotepad.co.uk">info@csnotepad.co.uk</a><br><br>
													</td>
												</tr>
												<tr>
													<td>
		...
		$mail->Body= <<<HTML
			<body bgcolor="#f2f2f2" style="background: #f2f2f2;">
				<table width="500" align="center" cellpadding="0" cellspacing="10" bgcolor="#ffffff" style="background: #ffffff;">
					...
					<tr><td><strong style="font-weight: bold;">PDF came from:HTTP_REFERER</strong></td><td>{$_SERVER['HTTP_REFERER']}</td></tr>
				</table>
			</body>
HTML;
