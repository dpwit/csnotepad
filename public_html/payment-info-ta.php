	...
	<body>
		...
		<?php else : ?>
			...
			<div style="margin: 0 auto; width: 1323px;">
				...
				<div>
					<form action="/form-to-email-payment-info-ta" id="paymentForm" method="POST">
						<div class="form_row bg-call-plan-box" style="display: inline-flex; margin: auto; padding: 10px;">
							...
							<div style="display: inline-block; margin: 20px 0 20px 20px; width: 33%;">
								<div>
									...
									<div  class="form_row" style="border: 1px solid #39F; margin-top: 20px; padding: 10px; width: 385px;">
