...
session_start();
	...
	define(CONTACT_FAIL,		'signup-mailbox.php');
	...
	$email_from = 'contact@csnotepad.co.uk';
        ...
        if(!$captcha){
			header("Location: signup-mailbox.php?CaptchaFail=True#recaptchaerror");
		...
		$mail->Body= <<<HTML
			<body bgcolor="#f2f2f2" style="background: #f2f2f2;">
				<table width="500" align="center" cellpadding="0" cellspacing="10" bgcolor="#ffffff" style="background: #ffffff;">
					...
					<tr><td><strong style="font-weight: bold;">Account Holder Name:</strong></td><td>{$values['firstName']}</td></tr>
