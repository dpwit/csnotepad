...
session_start();
	...
	define(CONTACT_SUCCESS,		'/html/content/testmedical-professionals.php');
	define(CONTACT_FAIL,		'/html/content/testmedical-professionals.php');
	//$mailto = 'contactus@csnotepad.co.uk';
	//$copyto = 'jim@bozboz.co.uk, webcontact@bozboz.co.uk';
	$mailto = 'rdonald@csnotepad.co.uk, wfrancis@csnotepad.co.uk, tlownds@csnotepad.co.uk, darren.whatford@dpwit.co.uk';
	$email_from = 'Website Enquiry <info@csnotepad.co.uk>';
        ...
        if(!$captcha){
			header("Location: /html/content/testmedical-professionals.php?CaptchaFail=True#recaptchaerror");
