...
session_start();
	...
	define(CONTACT_SUCCESS,		'/virtual-receptionist-faq.php');
	define(CONTACT_FAIL,		'/virtual-receptionist-faq.php');
	...
	$email_from = 'Website Enquiry <info@csnotepad.co.uk>';
        ...
        if(!$captcha){
			header("Location: virtual-receptionist-faq.php?CaptchaFail=True#recaptchaerror");
