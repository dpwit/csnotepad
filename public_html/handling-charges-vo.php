		...
		<?php else : ?>
			...
			<div class="box-fancy">
				<form id="support-form" action="" method="POST">
					...
					<h1 class="fancy" style="font-size: 34px; margin-top: 10px;">Mail handling charges</h1>
					...
					<div class="form-row">
						<h3 class="fancy" style="font-size: 14px; padding-left: 0px; width: 525px;">
							...
							<br>
							<font style="font-size: 14px;">If you would like your mail forwarded on to you, we will charge:
							<br>
							Letters &ndash; 75p + postage<br>
							Parcels/recorded delivery items &ndash; &pound;1.50 + postage
							<br>
							<br>
							Note, on months where post is forwarded, the total minimum charge is &pound;3.
							<br>
							<br>
							...
							<br>
							<br>
							Note, on months where mail is emailed to you, the total minimum charge is &pound;3.
							<br>
							<br>
							<font style="color: #39F;"><strong>Stored for collection</strong></font>
							<br>
							If you would like your mail stored for collection we will charge:
							<br>
							Letters &ndash; 75p
							<br>
							...
							<br>
							<br>
							Note, mail received on your behalf and stored for collection will be held for free for the first 30 days. We will charge &pound;5 a month plus VAT for all mail still being held after 30 days (up to 50 letters can be held).
							<br>
						</h3>
					</div>
