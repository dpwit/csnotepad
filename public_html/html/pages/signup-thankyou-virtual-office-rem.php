...
<html>
	<head>
		...
		<title>Thank you | Signup Virtual Office</title>
		...
		<script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'AW-1055112536'); 
		</script> 
	...
	<body>
		...
		<noscript>
			...
			<p class="validation-success notes">
				...
				<br>
				<br>
				<a href="/virtual-office-rem" title="Back to Home page">
