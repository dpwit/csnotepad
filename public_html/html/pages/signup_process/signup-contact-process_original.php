<?php
	...
	switch($service) {
		case 'Telephone':
			$file['name'] = 'Virtual Receptionist.pdf';
			$file['path'] = dirname(__FILE__) . '/virtual_receptionist.pdf';
			break;
		case 'Order taking':
			$file['name'] = 'Virtual PA.pdf';
			$file['path'] = dirname(__FILE__) . '/virtual_pa.pdf';
			break;
		case 'Virtual address':
			$file['name'] = 'Virtual Office.pdf';
			$file['path'] = dirname(__FILE__) . '/virtual_office.pdf';
			break;
		default:
