...
session_start();
	...
	define(CONTACT_FAIL,		'/html/pages/signup_process/signup-telephone.php');
	...
	$email_from = 'contact@csnotepad.co.uk';
        ...
        if(!$captcha){
			header("Location: /html/pages/signup_process/signup-telephone.php?CaptchaFail=True#recaptchaerror");
					...
					<tr>
						<td>
							<table style="font-size: 14px; font-family: Arial" cellspacing="5">
								<tr><td><a title="Virtual Receptionist Services by CSnotepad" href="http://www.csnotepad.co.uk/"><img title="CSnotepad - Virtual Receptionist and Virtual Office Services" alt="Virtual Receptionist and other virtual office services by CSnotepad" src="http://www.csnotepad.co.uk/images/logo_auto_email.png"></a><br/></td>
