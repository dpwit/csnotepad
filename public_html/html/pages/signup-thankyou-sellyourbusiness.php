...
<html>
	<head>
		...
		<title>Thank you | Sell your business</title>
	...
	<body>
		...
		<noscript>
			...
			<br>
			<h1 class="fancy" style="border-bottom: none; color: #505050; font-size: 24px; font-weight: 400; width: 885px;">Thank you</h1>
			<br>
			...
			<p class="validation-success notes" style="color: #505050; margin-left: auto; margin-right: auto; text-align: left; width: 810px;">
				<br>
				<br>
				Thank you for getting in touch. We've recieved your details and will be in contact with you shortly.
				<br>
				<br>
			</p>
			...
			<p class="validation-success notes">
				<strong>Thank you for your interest in CSnotepad</strong>
				<br>
				<br>
				<a href="/sell-your-business/" title="Back to Home page">
