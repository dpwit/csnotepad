<?php
	...
	if(!isset($_SESSION['user-feedback']['errors'])) {
		...
		$mail->FromName = $name;
		$mail->Subject = 'Freetrial request';
		$mail->AddAddress('rdonald@csnotepad.co.uk, wfrancis@csnotepad.co.uk');
		$mail->Body= <<<HTML
					...
					<tr>
						<td>
							<table style="font-size: 14px; font-family: Arial" cellspacing="5">
								<tr><td colspan="2">You have received a free trial request.</td></tr>
