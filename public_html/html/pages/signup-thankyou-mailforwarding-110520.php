...
<html>
	<head>
		...
		<title>Thank you | Signup Mail Forwarding</title>
		...
		<noscript><img src="https://elite-s001.com/images/track/24663.png?trk_user=24663&trk_tit=jsdisabled&trk_ref=jsdisabled&trk_loc=jsdisabled" height="0px" width="0px" style="display:none;" /></noscript>
	...
	<body>
		...
		<noscript>
			...
			<p class="validation-success notes">
				...
				<br>
				<br>
				<a href="/mailforwardingservice" title="Back to Home page">
	...
	<script>
		...
		document.getElementById('getEmail').innerHTML = localStorage.getItem('emailAddress');
