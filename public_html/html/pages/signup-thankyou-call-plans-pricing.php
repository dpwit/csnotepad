...
<html lang="en-GB">
	<head>
		...
		<title>Thank you | Signup Telephone Answering Pricing</title>
	...
	<body>
		...
		<noscript>
			...
			<br>
			<h1 class="fancy" style="border-bottom: none; color: #505050; font-size: 34px; font-weight: 700; padding-bottom: 0; width: 885px;">Hurrah...</h1>
			<br>
			...
			<p class="validation-success notes" style="color: #505050; margin-left: auto; margin-right: auto; text-align: left; width: 810px;">
				<br>
				<br>
				<strong>Hurrah...</strong> <?php
				echo "we've sent a message to " . $_SESSION["email"] . " with a link to your Terms & Conditions."
				?>
				<br>
				<br>
			...
			<p class="validation-success notes">
				<strong><a href="/csnotepad-agreement.php" style="font-size: 22px;" target="_blank">Terms & Conditions</a></strong>
				<br>
				<br>
				<!--<a href="/html/pages/setting-up-your-service-ta.php" title="Set up your service">
					<button type="submit" name="submit" value="submit" class="homepageleft" style="float: none; margin-left: 0; width: auto;">Set up your service</button>
				</a>-->
				<a href="/telephone-answering-service.php" title="Back">
