  ...
  ga('send', 'pageview');
	...
	<div id="wrappernewfull">
		...
		<!--<h1>Personalised Business Telephone Answering Services</h1>-->
			...
			<a href="/html/content/testreasons.php" title="Why us?">Why us?</a>
			</li>
...
<div id="wrapperhead">
	<div id="headlinetop">
		<div class="newsite_headline">Virtual Receptionist Services
...
<div id="subtitle">
	<div class="newsite_headline_welcome">Welcome to CSnotepad…</div>
<br>
<div class="newsite_text">When it comes to virtual receptionist services we like to <b>do things a little differently.</b> We start with you telling us exactly <b>what you need</b> and about <b>how you would like the service to work.</b>
<br>
<br>
You might want us at the forefront of your calls, <b>freeing up your time</b> and directing callers to the most appropriate person or department. Or maybe you want a <b>trusted, reliable</b> team of <b>professional virtual receptionists</b> to just be there to <b>answer any calls you can’t</b> throughout the day.</b>
<br>
<br>
Whatever your specific reason for looking at using a virtual receptionist service, we’ll make sure you <b>get the service you want, when you want it… tailored to fit your business perfectly.</b>    
</div>
</div>

<div id="wrappernewtitles">
	<div id="firsttitle">Compare Services
		<br>
		<img src="/images/greyline_gradient_200px.png" alt="grey line"></img>
		<br>
	</div>
	
	<div id="thirdtitle">Get in touch
		<br>
		<img src="/images/greyline_gradient_200px.png" alt="grey line"></img>
		<br>
	</div>
...
<div id="wrappernew1">
	<div id="first">
		<img src="/images/CS_comparison_table_V2_700x407.png" alt="Comparison Table" title="Comparison Table"></img> <!--was 700x400.png filename-->
	</div>
...
<br>
			...
			<div style="margin-left: 56px"><button type="submit" name="submit" value="submit" class="homepageleft">Call me</button></div>
...
<div id="secondtitleright">What our customers say
	...
	<div id="testimonialsnew2">
		<img src="/images/CallumFowler_clear.png">Very helpful, organised and professional.  Personally, I would highly recommend CSnotepad</img>
	</div>
</div>
<div id="wrappernew1">
	<div id="secondleft">
		<div id="secondtitleright">Special offer
		<br>
		<img src="/images/greyline_gradient_200px.png" alt="grey line"></img>
		<br>
		</div>
		<img class="middle" src="/images/eBook_TestImage.png" alt="eBook" title="eBook"></img>
	</div>
	...
	<div id="secondright">
		...
		<a href="/our-services/order-taking"><img class="middlehome" src="/images/New Support Ticket Logging.png" alt="Support Ticket Logging" title="Support Ticket Logging"></img></a>
		<span><a href="/our-services/virtual-address" title="Virtual Address"><img class="middlehome" src="/images/New Virtual Address.png" alt="Virtual Address"></img></a></span>
		
		<a href="/our-services/telephone-answering-brighton" title="Telephone Answering"><img class="middlehome" src="/images/New Telephone Answering.png" alt="Telephone Answering"></img></a>
		<span><a href="/our-services/order-taking" title="Order Taking"><img class="middlehome" src="/images/New Order Taking.png" alt="Order Taking"></img></a><span>
