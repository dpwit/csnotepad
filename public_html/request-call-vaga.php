...
session_start();
	...
	define(CONTACT_SUCCESS,		'/virtual-office-ga.php');
	define(CONTACT_FAIL,		'/html/our-services/virtual-address-ga');
	...
	$email_from = 'Website Enquiry <info@csnotepad.co.uk>';
        ...
        if(!$captcha){
			header("Location: /html/our-services/virtual-address-ga?CaptchaFail=True#recaptchaerror");
