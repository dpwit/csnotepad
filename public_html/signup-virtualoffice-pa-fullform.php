...
<html lang="en-GB">
	<head>
		<title>Sign up from | CSnotepad</title>
	...
	<body>
		...
		<?php else : ?>
			...
			<div style="margin: 0 auto; width: 1323px;">
				...
				<div>
					<form action="/form-to-email-virtualoffice-pa" id="paymentForm" method="POST">
							...
							<div style="display: inline-block; margin: 20px; width: 34%;">
								...
								<div  class="form_row" style="border: 1px solid #39F; padding: 10px; width: 450px;">
									<h3 class="fancy" style="font-size: 15px; color: #241c15; padding: 0px; margin-top: 0px;">
										<font color="#ff8834">•</font>&nbsp;3 months in advance &ndash; &pound;36.00 (equivalent to just &pound;12.00 a month)
										<br>
										<br>
										<font color="#ff8834">•</font>&nbsp;6 months in advance &ndash; &pound;58.08 (equivalent to just &pound;9.68 a month)
										<br>
										<br>
										<font color="#ff8834">•</font>&nbsp;12 months in advance &ndash; &pound;88.80 (equivalent to just &pound;7.40 a month)
										<br>
									</h3>
									...
									<select name="term" id="term" required onchange="displayTerm()">
										<option value="">Please choose...</option>
										<option value="36.00">&pound;36.00 &ndash; <span value="3 months in advance">3 months in advance</span></option>
										<option value="58.08">&pound;58.08 &ndash; <span value="6 months in advance">6 months in advance</span></option>
										<option value="88.80">&pound;88.80 &ndash; <span value="12 months in advance">12 months in advance</span></option>
									</select>
									<br>
