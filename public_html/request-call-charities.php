...
session_start();
	...
	define(CONTACT_SUCCESS,		'/telephone-answering-charities.php');
	define(CONTACT_FAIL,		'/html/content/telephone-answering-charities.php');
	...
	$email_from = 'Website Enquiry <info@csnotepad.co.uk>';
        ...
        if(!$captcha){
			header("Location: /html/content/telephone-answering-charities.php?CaptchaFail=True#recaptchaerror");
