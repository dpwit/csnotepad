...
session_start();
	...
	define(CONTACT_SUCCESS,		'/virtual-address-li.php');
	define(CONTACT_FAIL,		'/html/our-services/virtual-address-li');
	...
	$email_from = 'Website Enquiry <info@csnotepad.co.uk>';
        ...
        if(!$captcha){
			header("Location: /html/our-services/virtual-address-li?CaptchaFail=True#recaptchaerror");
