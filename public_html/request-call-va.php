...
session_start();
	...
	define(CONTACT_SUCCESS,		'/virtual-office.php');
	define(CONTACT_FAIL,		'/html/our-services/virtual-address');
	...
	$email_from = 'Website Enquiry <info@csnotepad.co.uk>';
        ...
        if(!$captcha){
			header("Location: /html/our-services/virtual-address?CaptchaFail=True#recaptchaerror");
