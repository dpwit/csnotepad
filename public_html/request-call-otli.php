...
session_start();
	...
	define(CONTACT_SUCCESS,		'/order-taking-li.php');
	define(CONTACT_FAIL,		'/html/our-services/order-taking-li');
	...
	$email_from = 'Website Enquiry <info@csnotepad.co.uk>';
        ...
        if(!$captcha){
			header("Location: /html/our-services/order-taking-li?CaptchaFail=True#recaptchaerror");
