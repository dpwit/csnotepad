...
session_start();
	...
	define(CONTACT_FAIL,		'signup-charities-rem.php');
	...
	$email_from = 'contact@csnotepad.co.uk';
        ...
        if(!$captcha){
			header("Location: signup-charities-rem.php?CaptchaFail=True#recaptchaerror");
	...
	switch($service) {
		...
		case 'Virtual address':
			...
			break;
		case 'Charities':
			$file['name'] = 'CSnotepad telephone answering for Charities rem.pdf';
			$file['path'] = dirname(__FILE__) . '/html/pages/signup_process/CSnotepad telephone answering for Charities rem.pdf';
			break;
		default:
