...
session_start();
	...
	define(CONTACT_FAIL,		'signup-mailbox-fullform-fb.php');
	...
	$email_from = 'contact@csnotepad.co.uk';
        ...
        if(!$captcha){
			header("Location: signup-mailbox-fullform-fb.php?CaptchaFail=True#recaptchaerror");
					...
					<table height="100%" width="100%" cellpadding="0" cellspacing="0" border="0">
						<tr>
						    <td valign="top" align="left" background="https://www.csnotepad.co.uk/images/background-personalva-email.png">
								<table width="550" align="center" cellpadding="0" cellspacing="10" bgcolor="#ffffff" style="background: #ffffff;">
									<tr>
										<td>
		...
		$mail->Body= <<<HTML
			<body bgcolor="#f2f2f2" style="background: #f2f2f2;">
				<table width="500" align="center" cellpadding="0" cellspacing="10" bgcolor="#ffffff" style="background: #ffffff;">
					...
					<tr><td><strong style="font-weight: bold;">Addditional names:</strong></td><td>{$_POST['nameTwo']}</td></tr>
					<tr><td><strong style="font-weight: bold;">Additional names:</strong></td><td>{$_POST['nameThree']}</td></tr>
					...
					<tr><td><strong style="font-weight: bold;">Security deposit checked:</strong></td><td>{$_POST['secdep']}</td></tr>
