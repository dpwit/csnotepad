...
session_start();
	...
	define(CONTACT_SUCCESS,		'/telephone-answering-service');
	define(CONTACT_FAIL,		'/html/our-services/telephone-answering-brighton');
	...
	$email_from = 'Website Enquiry <info@csnotepad.co.uk>';
        ...
        if(!$captcha){
			header("Location: /html/our-services/telephone-answering-brighton?CaptchaFail=True#recaptchaerror");
