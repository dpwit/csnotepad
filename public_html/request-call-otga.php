...
session_start();
	...
	define(CONTACT_SUCCESS,		'/order-taking-ga.php');
	define(CONTACT_FAIL,		'/html/our-services/order-taking-ga');
	...
	$email_from = 'Website Enquiry <info@csnotepad.co.uk>';
        ...
        if(!$captcha){
			header("Location: /html/our-services/order-taking-ga?CaptchaFail=True#recaptchaerror");
