...
src="//www.googleadservices.com/pagead/conversion/1055112536/?label=5262CN-YjWkQ2PqO9wM&amp;guid=ON&amp;script=0"/>
		...
		<?php else : ?>
			...
			<div style="margin: 0 auto; width: 1323px;">
				...
				<div>
					<form action="/form-to-email" id="paymentForm" method="POST">
							...
							<div style="display: inline-block; margin: 20px; width: 34%;">
								...
								<div id="first" style="width: 250px; margin-top: -10px; display: inline-block;">
									...
									<div class="form_row">
										...
										<select name="service" id="service" onchange="displayService()">
								...
								<div  class="form_row" style="border: 1px solid #39F; padding: 10px; width: 450px;">
									...
									<select name="term" id="term" onchange="displayTerm()">
										<option value="Please choose">Please choose...</option>
						...
						<div style="display: inline-flex; margin: auto;">
							<div style="display: inline-block; margin: 0 20px 20px 20px; width: 37%;">
								...
								<div class="form_row" style="color: #241c15; margin: 20px 0 20px 10px; text-align: center; width: 500px;">
									<label for="subtotal" style="color: #241c15; font-size: 18px;">Sub total:</label> &pound;<span id="termAmount"></span>
									<hr>
									...
									<hr>
									<label for="termTotal" style="color: #241c15; font-size: 18px;">Total:</label> <textarea name="termTotal" id="termTotal" style="margin-left: auto; margin-right: auto; border: none; width: 48px; font-family: arial" readonly=""></textarea>
									<hr>
		...
		function displayTerm() {
		    ...
		    document.getElementById("vat").innerHTML = (getterm * 0.2).toFixed(2);

		    var vat = document.getElementById("vat").innerHTML = (getterm * 0.2).toFixed(2);
