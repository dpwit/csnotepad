...
$_SESSION['get-email'] = $_POST['email'];
	...
	define(CONTACT_SUCCESS,		'/html/pages/signup-thankyou-po-box.php');
	define(CONTACT_FAIL,		'signup-po-box-fullform.php');
	...
	$email_from = 'contact@csnotepad.co.uk';
        ...
        if(!$captcha){
			header("Location: signup-po-box-fullform.php?CaptchaFail=True#recaptchaerror");
...
HTML;
	...
	header('location: /html/pages/signup-thankyou-po-box.php');
