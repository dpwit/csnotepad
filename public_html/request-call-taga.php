...
session_start();
	...
	define(CONTACT_SUCCESS,		'/telephone-answering-brighton-ga.php');
	define(CONTACT_FAIL,		'/html/our-services/telephone-answering-brighton-ga');
	...
	$email_from = 'Website Enquiry <info@csnotepad.co.uk>';
        ...
        if(!$captcha){
			header("Location: /html/our-services/telephone-answering-brighton-ga?CaptchaFail=True#recaptchaerror");
