...
$_SESSION['get-email'] = $_POST['email'];
	...
	define(CONTACT_SUCCESS,		'/html/pages/signup-thankyou-virtualoffice.php');
	define(CONTACT_FAIL,		'signup-virtualofice-fullform.php');
	...
	$email_from = 'contact@csnotepad.co.uk';
        ...
        if(!$captcha){
			header("Location: signup-virtualofice-fullform.php?CaptchaFail=True#recaptchaerror");
...
HTML;
	...
	header('location: /html/pages/signup-thankyou-virtualoffice.php');
