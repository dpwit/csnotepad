...
session_start();
	...
	define(CONTACT_SUCCESS,		'/html/pages/signup-thankyou-freetrial.php');
	define(CONTACT_FAIL,		'signup-charities-freetrial.php');
	...
	$email_from = 'contact@csnotepad.co.uk';
        ...
        if(!$captcha){
			header("Location: signup-charities-freetrial.php?CaptchaFail=True#recaptchaerror");
	...
	if($telephone === '') {
		$_SESSION['user-feedback']['errors']['telephone'] = 'Please provide a telephone number';
		$_SESSION['user-feedback']['success'] = false;
	}
	...
	switch($service) {
		case 'Telephone':
			$file['name'] = 'CSnotepad telephone answering information pack freetrial.pdf';
			$file['path'] = dirname(__FILE__) . '/html/pages/signup_process/CSnotepad telephone answering information pack freetrial.pdf';
			break;
		case 'Order taking':
		...
		case 'Virtual address':
			...
			break;
		case 'Charities':
			$file['name'] = 'CSnotepad telephone answering for Charities freetrial.pdf';
			$file['path'] = dirname(__FILE__) . '/html/pages/signup_process/CSnotepad telephone answering for Charities freetrial.pdf';
			break;
		default:
									...
									<tr>
										<td>
											<table style="font-size: 14px; font-family: Arial" cellspacing="5">
												...
												<tr>
													<td>
														<strong>CSnotepad - Information Pack</strong><br/><br/>
													</td>
												</tr>
												<tr>
													<td>
...
HTML;
	...
	if($_SESSION['user-feedback']['success']) {
		header('location: /html/pages/signup-thankyou-freetrial.php');
	}
	else  {
		header($_SESSION['user-feedback']['errors']);
	}
