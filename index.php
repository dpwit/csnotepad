...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Postal address service</title>
		<meta name="description" content="Providing customers' all over the world with a low cost, secure, virtual postal address service based in Brighton, East Sussex." />
		<meta name="keywords" content="Postal Address Service, Virtual Postal Address">
...
?>
	<body> 
		...
		<a name="Home"></a>
		<div id="wrappernewfullpostaladdress" title="Virtual mailbox and mailing address services">
		...
		<div id="wrappernewfullwelcomemailbox" title="CSnotepad Telephone Answering Testimonials">
			...
			<div id="topBarNewSTL">
				<div class="newsitehometestimonials_text" style="font-size: 14px;">
					...
					<br>
					<br>
					Our virtual postal address service is best suited for customers' who expect to receive post and/or small packages; put simply, anything that would fit through a letterbox.
					<br>
					<br>
					...
					<br>
					<u>Please note that this service is for personal customers' only</u> &ndash; customers' looking for a virtual office address service, including Registered Office address and Directors Service Address <a href="/virtual-office">CLICK HERE</a>.
					<br>
					<br>
			...
			<div id="topBarNewSTL">
				<a name="howitworks"></a>
					<div class="newsitehometa_text" style="font-size: 14px;">
						...
						<a href="/signup-mailbox-fullform" rel="fancybox-support" class="fancybox.iframe">
							<button type="submit" name="submit" value="submit" class="homepageta" style="margin-top: 80px; margin-left: 245px;">Set up your secure UK postal address</button>
						</a>
					</div>
				<div class="clear"></div>
			</div>
